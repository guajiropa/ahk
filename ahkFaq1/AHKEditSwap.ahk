...
/**
 * ============================================================================ *
 * @Author           : Joe Glines<Joe@the-Automator.com>
...
;                  ,configfile   : A_ScriptDir "\AHKEditSwap_settings.ini"
...
Menu, Tray, Icon, %A_WinDir%\system32\shell32.dll,253 ;Set custom Script icon
...
global script := {base         : script
                 ...
                 ,homepagelink : "https://the-Automator.com/EditSwap"
                 ,donateLink   : "https://www.paypal.com/donate?hosted_button_id=MBT5HSD9G94N6"
                 ,resfolder    : A_ScriptDir "\res"
                 ;~ ,iconfile     : A_ScriptDir "\res\sct.ico"
                 ,configfile   : A_ScriptDir "\AHKEditSwap_settings.ini"
...
IniRead, editHistory, % "AHKEditSwap_settings.ini", % "History"
...
if (editHistory != ""){
	...
	IniWrite, % currentEditor, % "AHKEditSwap_settings.ini", % "History", % currentEditorName
	IniWrite, % currentEditor, % "AHKEditSwap_settings.ini", % "Current", % currentEditorName
}
...
saveEditor(newEditorPath){
	...
	IniDelete, % "AHKEditSwap_settings.ini", % "Current"
	IniWrite, % newEditorPath, % "AHKEditSwap_settings.ini", % "Current", % newEditorName
	IniWrite, % newEditorPath, % "AHKEditSwap_settings.ini", % "History", % newEditorName
